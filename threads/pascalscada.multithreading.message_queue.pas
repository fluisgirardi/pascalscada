...
type
  ...
  public
    ...
    {$ENDIF}
    function  PeekMessage(out Msg:TpSCADAMsg; uFilterMinMsg, uFilterMaxMsg:Cardinal; Remove:Boolean):Boolean;
...
function TpSCADAMessageQueue.PeekMessage(out Msg:TpSCADAMsg; uFilterMinMsg, uFilterMaxMsg:Cardinal; Remove:Boolean):Boolean;
var
